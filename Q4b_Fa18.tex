...
\begin{parts}
	\part[2]  Find $\displaystyle f^{-1}(0)$. Show your work step by step.
...
\question Let $\displaystyle f(x)=\frac{1}{x}$ and $\displaystyle g(x)=\frac{1}{2x}$.
