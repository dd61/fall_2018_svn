...
\begin{parts} 
	...
	\begin{oneparchoices}
		...
		\choice False
	\end{oneparchoices}
	\part[1]  $\displaystyle \log\left (\sqrt[\leftroot{-3}\uproot{3}3]{10^{\scaleto{2}{6pt}}}\right )  =\frac{2}{3}$.  
	\begin{oneparchoices}
		\choice True
		\choice False
	\end{oneparchoices}	
	...
	\begin{oneparchoices}
		...
		\choice False
	\end{oneparchoices}
	\part[1] $\displaystyle \log_5 12$ is between 1 and 2.
		\begin{oneparchoices}
			\choice True
			\choice False
		\end{oneparchoices}
...
\question[2] Solve the equation $\displaystyle \log_2 x=2$. Simplify Your answer as much as possible.
