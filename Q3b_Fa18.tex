...
\begin{parts}
	...
	\part[2] Write the range of $\displaystyle f\left (\frac{x}{2}\right )$ in interval form. \dotfill 
...
%\begin{multicols}{2}
	...
	\item  Vertical shift down 3 unit.
		\end{enumerate}
...
\choice The total cost of tuition has increased by \$100;
	\choice The total cost of tuition has increase by \$1000.
\end{oneparchoices}
\end{questions}
