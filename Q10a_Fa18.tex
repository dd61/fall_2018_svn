...
\begin{parts}
	\part[1] $\displaystyle t=-\frac{2\pi}{3}$
...
\begin{parts}
	...
	\part[1] $\displaystyle y=2\sin\left (\frac{x}{2}\right )$ \dotfill
\end{parts}
...
\begin{parts}
	...
	\bonuspart[1] $\displaystyle \sin\left( -\frac{5\pi}{6} \right)$ \dotfill
\end{parts}	
...
\begin{parts}
	...
	\begin{oneparchoices}
		\choice $y=115$; \choice $y=110$; \choice $y=60$; \choice $y=55$; \choice $y=24$; 	\choice $y=5$.
	\end{oneparchoices}
	
	\part[1] The amplitude of $H(t)$ is:
	
	\begin{oneparchoices}
		\choice 115; \choice 110; \choice 60; \choice 55; \choice 24; \choice 5.
	\end{oneparchoices}
