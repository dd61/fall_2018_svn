...
\extraheadheight{-.3in}
\runningheadrule
\firstpageheader{\bfseries {Precalculus}}{ \Large {Quiz 2 }}{\bfseries {9/18/18}} 
...
\begin{parts}
	...
	\part[2] \label{part:one} Find $F(70)$ and explain how You arrived at Your answer.
	
	\fillwithdottedlines{1.5cm}
	
		\part[2] \label {part:two} Find $F(50)$ and explain how You arrived at Your answer.
