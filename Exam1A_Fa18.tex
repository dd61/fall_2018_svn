...
\begin{enumerate}
	\item Vertical shift up 3 units, followed by:
...
\part[2] The rational function $\displaystyle f(x)=\frac{x^2+1}{x-2}$ has a slant asymptote.

\fillwithdottedlines{2cm}

\end{parts}
\bonusquestion[1] True or False? The range of the polynomial function $\displaystyle f(x)=2x^4+3x+4$ is all real numbers.
\begin{oneparchoices}
