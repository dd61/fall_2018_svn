...
\extraheadheight{-.3in}
\runningheadrule
\firstpageheader{\bfseries {Precalculus}}{ \bfseries {Quiz 8 }}{\bfseries {11/13/18}} 
...
\begin{parts} 
	\bonuspart[1]  $\displaystyle \log(0.1) < 0$. 
	\begin{oneparchoices}
		\choice True
		\choice False
	\end{oneparchoices}
	\part[1]  $\displaystyle \log\left (\sqrt[\leftroot{-3}\uproot{3}3]{10}\right )  =\frac{1}{3}$. 
	\begin{oneparchoices}
		\choice True
		\choice False
	\end{oneparchoices}	
	\bonuspart[1]  $\displaystyle \log\left (xy^3\right )  =3\left (\log x + \log y \right)$. 
	\begin{oneparchoices}
		\choice True
		\choice False
	\end{oneparchoices}
	\part[1] $\displaystyle \log 73$ is between 1 and 2.
		\begin{oneparchoices}
			\choice True
			\choice False
		\end{oneparchoices}
...
\question[2] Solve the equation $\displaystyle \log_4 x=2$. Simplify Your answer as much as possible.
